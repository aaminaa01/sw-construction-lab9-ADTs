...
public class GraphPoetTest {
    ...
    */
    ...
    // Making different graphPoet class instances
    ...
    final GraphPoet graphOneLine2 = instantiateGraph("test/poet/TestOneLine(2).txt");
    ...
    public void testGraphPoet_OneLine() {
        ...
        List<String> corpusWords2 = graphOneLine2.getCorpusWords();
    ...
    public void testPoem_MultipleWords() {
        ...
        String input2 = "Test the system.";
        String output2 = graphOneLine2.poem(input2);
        String expected2 = "Test of the system.";
